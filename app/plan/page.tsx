            ...
            <p>
              <label>① 知識・技能：<br />
                <textarea
                  ...
                  onChange={(e) => setEvaluationPoints({ ...evaluationPoints, knowledge: e.target.value })}
                  rows={3}
                  cols={50}
                />
              </label>
            ...
            <p>
              <label>② 思考・判断・表現：<br />
                <textarea
                  ...
                  onChange={(e) => setEvaluationPoints({ ...evaluationPoints, thinking: e.target.value })}
                  rows={3}
                  cols={50}
                />
              </label>
            ...
            <p>
              <label>③ 主体的に学習に取り組む態度：<br />
                <textarea
                  ...
                  onChange={(e) => setEvaluationPoints({ ...evaluationPoints, attitude: e.target.value })}
                  rows={3}
                  cols={50}
                />
              </label>
